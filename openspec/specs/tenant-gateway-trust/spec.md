# tenant-gateway-trust

## Purpose

TBD - definir o propósito desta capability (endurecimento da confiança entre o gateway e o microservice quanto à identificação do tenant via headers).
